package com.codingmonster.pricer;
...
public class PricerAgentRunner {
  ...
  public PricerAgentRunner(int subStreamId, int pubStreamId, String subChannel, String pubChannel) {
  ...
  void start() {
    try (Aeron aeron = Aeron.connect()) {
      Agent agent = new PricerAgent(aeron, pubChannel, pubStreamId, subChannel, subStreamId);
      AgentRunner runner =
          new AgentRunner(
